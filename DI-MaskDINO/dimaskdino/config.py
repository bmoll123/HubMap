...
def add_dimaskdino_config(cfg):
    ...
    cfg.INPUT.HUBMAP_IMG_SIZE = 768   # 宣告預設值
    ...
    cfg.MODEL.MaskDINO.TI_LAYERS = 2
    ...
    cfg.MODEL.MaskDINO.FIRST_SELECTED_QUERIES = 600
    cfg.MODEL.MaskDINO.NUM_GUIDING_TOKENS = 50
